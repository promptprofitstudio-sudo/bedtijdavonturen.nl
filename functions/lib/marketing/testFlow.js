...
const kdvCampaignId = (0, params_1.defineSecret)('INSTANTLY_CAMPAIGN_KDV');
const schoolCampaignId = (0, params_1.defineSecret)('INSTANTLY_CAMPAIGN_SCHOOL');
const proCampaignId = (0, params_1.defineSecret)('INSTANTLY_CAMPAIGN_PRO');
/**
...
exports.testPartnerFlow = (0, https_1.onRequest)({
    ...
    const searchTerm = req.query.term || 'kinderdagverblijf';
    ...
    try {
        ...
        const discovered = {
            name: business.title,
            rating: ((_f = business.rating) === null || _f === void 0 ? void 0 : _f.value) || 0,
        ...
        const contactType = !enrichment.email ? 'form_only'
        ...
        if ((_h = (_g = enrichment.factPack) === null || _g === void 0 ? void 0 : _g.mentionedKeywords) === null || _h === void 0 ? void 0 : _h.parents) {
        ...
        if ((_k = (_j = enrichment.factPack) === null || _j === void 0 ? void 0 : _j.mentionedKeywords) === null || _k === void 0 ? void 0 : _k.education) {
            factsWithEvidence.push({
        ...
        if ((_l = enrichment.factPack) === null || _l === void 0 ? void 0 : _l.hasSocialMedia) {
            factsWithEvidence.push({
        ...
        const messageKit = await generateMessageKit(discovered, enrichment, segment, contactType, firstName, factsForPrompt, // V7: Pass formatted facts with evidence types
        offerType, ctaType, openaiApiKey.value());
        ...
        const leadPayload = {
            ...
            custom_variables: {
                ...
                subject_a: messageKit.subjectA,
                subject_b: messageKit.subjectB,
                subjectA: messageKit.subjectA,
                ...
                // Context
                city: city,
                rating: ((_m = discovered.rating) === null || _m === void 0 ? void 0 : _m.toString()) || 'N/A',
                // Tracking
        ...
        const instantlyRes = await axios_1.default.post('https://api.instantly.ai/api/v2/leads', {
            campaign: campaignId,
 ...
 */
function detectSegment(name, category) {
 ...
 */
async function enrichLead(business, hunterKey) {
    var _a, _b, _c;
    const result = {
    ...
    try {
        ...
        // RAIL 1: Hunter.io
        try {
            const hunterRes = await axios_1.default.get(`https://api.hunter.io/v2/domain-search?domain=${domain}&api_key=${hunterKey}&type=personal`);
            const emails = ((_b = (_a = hunterRes.data) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.emails) || [];
        ...
        if (!result.email) {
            try {
                const pageRes = await axios_1.default.get(business.website, {
                    timeout: 10000,
                ...
                if (mailtoLinks.length > 0) {
                    const email = (_c = mailtoLinks.first().attr('href')) === null || _c === void 0 ? void 0 : _c.replace('mailto:', '');
 ...
 */
async function generateMessageKit(business, enrichment, segment, contactType, firstName, factsWithEvidence, // V7: Facts with evidence type labels
offerType, ctaType, openaiKey) {
    var _a, _b;
...
"Geen interesse? Laat het weten, dan stop ik."`;
    const city = ((_b = (_a = business.address) === null || _a === void 0 ? void 0 : _a.split(',').pop()) === null || _b === void 0 ? void 0 : _b.trim()) || 'Nederland';
 ...
 */
async function saveTestRun(log, startTime, success, status) {
